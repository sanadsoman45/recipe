...
public class Firebasesearchadapter extends RecyclerView.Adapter<Firebasesearchadapter.ViewHolder> {

    private final Context con;
    private ArrayList<firebasesearchmodel> listitems;
    private DatabaseHandler dbh;
    private FirebaseAuth firebaseAuth;
    private FirebaseUser firebaseUser;
    ArrayList<String> arr_recipe_names;

    public Firebasesearchadapter(Context con, ArrayList<firebasesearchmodel> listitems) {
        this.con = con;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Firebasesearchadapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        firebasesearchmodel lst=listitems.get(position);
        ...
        Log.d("boolmsg","msg is:"+dbh.getIngredient_fav(lst.getRecipe_name(),firebaseUser.getUid()));
